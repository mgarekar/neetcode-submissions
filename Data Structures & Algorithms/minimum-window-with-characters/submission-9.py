class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        for r in range(len(s)):
            ...
            if c in target_hm and target_hm[c] == window[c]:
                have = have+1

            # while( compare_hm(window, target_hm) ):#condition is valid
            while( have == need ):#condition is valid
                #valid substringt
                ...
                if window[lchar] == 0:
                    del window[lchar]
                if lchar in target_hm and window.get(lchar,0) < target_hm[lchar]:
                    have = have -1
                l=l+1
